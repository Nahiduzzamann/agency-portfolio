      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Explore Our IT Solutions</h2>
            <p className="text-xl text-gray-400">Discover how our IT services can streamline your business workflows and enhance productivity.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Custom Software Development</h4>
              <p className="text-lg text-gray-400 text-center">Tailored software solutions to meet your unique business requirements and streamline operations.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Offshore Software Development</h4>
              <p className="text-lg text-gray-400 text-center">Outsource your software development needs to our experienced team for cost-effective solutions and timely delivery.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Professional Outsourcing</h4>
              <p className="text-lg text-gray-400 text-center">Outsource your IT projects to our skilled professionals for efficient and reliable services.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Software Consultancy</h4>
              <p className="text-lg text-gray-400 text-center">Expert guidance and advice to help you make informed decisions about your software needs and strategies.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Technical Support</h4>
              <p className="text-lg text-gray-400 text-center">24/7 technical assistance and support to ensure smooth operation of your software systems.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">IT Training</h4>
              <p className="text-lg text-gray-400 text-center">Comprehensive training programs to empower your team with the latest IT skills and knowledge.</p>
            </div>
